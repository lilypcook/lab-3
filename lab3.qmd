...
```{r}
#| content: valuebox
#| title: Highest Belief in Safety of Vaccines
#| color: success
#| icon: emoji-smile

list(value = paste(highcountry, ":" , round(highpercent * 100, 2), "%"))
...
### Row - Vaccine Visualizations {height="" ="" "80%"=""}

```{r}
#| label: dot plot
#| title: Belief vaccines are safe by country and global region
#| message: false
